...
namespace Lab5
{
    class PersonV2 : Person
    {
        ...
        //New for Lab 8
        public string DeleteOnePersonV2(int id)
        {
            Int32 intRecords = 0;
            string result = "";
            ...
            try
            {
                ...
                result = intRecords.ToString() + " People Deleted from Database";
            }
            catch(Exception e)
            {
        ...
        //New for Lab 8
        public string UpdateAPersonV2(int id)
        {
            Int32 intRecords = 0;
            string result = "";
            ...
            string strConn = GetConnectionStr();
            string sqlString = "UPDATE PersonV2 SET FName = @FName, MName = @MName, LName = @LName, StreetOne = @StreetOne, StreetTwo = @StreetTwo, City = @City, StateCode = @StateCode, ZipCode = @ZipCode, PhoneNum = @PhoneNum, Email = @Email, CellNum = @CellNum, InstagramURL = @InstagramURL WHERE PersonID = @PersonID;";
            ...
            comm.Parameters.AddWithValue("@City", City);
            comm.Parameters.AddWithValue("@StateCode", StateCode);
            comm.Parameters.AddWithValue("@ZipCode", ZipCode);
            comm.Parameters.AddWithValue("@PhoneNum", PhoneNum);
            comm.Parameters.AddWithValue("@Email", EmailAddress);
            comm.Parameters.AddWithValue("@CellNum", CellNum);
