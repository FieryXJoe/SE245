    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            while (flag)
            {
                ...
                } while (!isValidDouble(temp));
                Double.TryParse(temp, out converted);
                lab1Grades.Add(converted);
