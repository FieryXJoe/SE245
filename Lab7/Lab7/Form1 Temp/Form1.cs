    ...
    public partial class Form1 : Form
    {
        ...
        public Form1(int intPersonID)
        {
            ...
            while (dr.Read())
            {
                ...
                txtFName.Text = dr["Title"].ToString();
                txtMName.Text = dr["AuthorFirst"].ToString();
                txtLName.Text = dr["AuthorLast"].ToString();
                txtStreetOne.Text = dr["Email"].ToString();
                txtStreetTwo.Text = dr["Pages"].ToString();
                txtCity.Text = dr["BookmarkPage"].ToString();
